var initialLocations = [
        {
            streetAddress: '5104 Emmanuel Dr.',
            city: 'Cross Lanes',
            state: 'WV'
        },
        {
            streetAddress: '5105 Big Tyler Road.',
            city: 'Charleston',
            state: 'WV'
        }
    ];
...
var ViewModel = function () {
    ...
    self.search = function(value) {
        ...
        for (var x in initialLocations) {
            if (initialLocations[x].city.toLowerCase().indexOf(value.toLowerCase()) >= 0) {
...
function initializeMap() {
    ...
    */
    function locationFinder() {
        ...
        // });
        // if (bio.contacts.otherLocations.length > 0) {
        //     bio.contacts.otherLocations.forEach(function(location) {
